...
const ArrowRight = ({ size=20, color = '#000' }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 448 512"
...
const ArrowLeft = ({ size=20, color = '#000' }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 448 512"
...
export { User, CircleUser, Lock, Envelope, Bars, CartShopping, Exit, Heart, Share, CategoryIcon, BoxCheck, Gear, ShareNodes, HouseChimney, ArrowRight, ArrowLeft };
